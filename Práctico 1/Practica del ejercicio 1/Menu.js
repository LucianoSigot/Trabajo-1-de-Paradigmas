...
export function menuAddTareas(){
    ...
    console.log("******************************");
    console.log("[1] Agregar titulo (*obligatorio)");
    console.log("[2] Agregar descripción (opcional)");
    console.log("[3] Agregar dificultad (Facil, media, dificil), por default (facil) ");
    ...
    console.log("[0] Volver al menu (Si no se cargan los campos obligatorios no se guardara la tarea)...");
}
