...
export function buscarTarea(aTareas) {
    ...
    // Filtra el arreglo para encontrar tareas con un título que contiene la búsqueda ingresada por el usuario
    let resultados = aTareas.filter(t => t.titulo.toLowerCase().includes(busqueda.toLowerCase()));
